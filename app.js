...
const callErrorRoutes = require('./routes/callerror');
...
app.use('/api/callerror', callErrorRoutes);
...
function handleJoinRoom(ws, { chat_id }) {
  ...
  console.log('Send update read status message');
